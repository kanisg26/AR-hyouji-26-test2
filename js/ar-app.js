...
(function () {
  ...
  function placePipe(position) {
    ...
    excavationGroup.visible = showExcavation;
  ...
  function setupEventListeners() {
    ...
    btnExcavation.addEventListener('click', () => {
      ...
      if (excavationGroup) excavationGroup.visible = showExcavation;
      excavationPanel.style.display = showExcavation ? 'block' : 'none';
      btnExcavation.classList.toggle('active', showExcavation);
    });
